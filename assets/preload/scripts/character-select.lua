...
local showSongBF = false -- Whether the chart's BF should be shown as an option, disabling might be useful if you manually registered them and the chart's BF shows wrong
...
function onCreate()
	if not (not allowStoryMode and isStoryMode) then 
		...
		makeLuaText('sustxt', 'Who will sing?', 0, 0, 100);
