...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var loadAutosaveBtn:FlxButton = new FlxButton(reloadSongJson.x, reloadSongJson.y + 30, 'Load Autosave Chart', function()
		{
		...
		var saveEvents:FlxButton = new FlxButton(110, reloadSongJson.y, 'Save Events JSON', function ()
		{
			saveEvents();
		});
